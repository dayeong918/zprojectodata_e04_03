		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind",
									"targetURL": "#ntzprojectodatae0403-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ntzprojectodatae0403-display": {
								"semanticObject": "ntzprojectodatae0403",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nt.zprojectodatae0403",
									"url": sap.ui.require.toUrl("nt/zprojectodatae0403")
								}
							}
						}
					}
